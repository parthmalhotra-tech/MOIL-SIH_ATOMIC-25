      ...
      <main className="relative z-10 flex-1 w-full pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <MetricCard icon={Sparkles} label="Active Recommendations" value={initialRecommendations.length} detail="Current recommendation queue" />
            <MetricCard
              icon={ShieldAlert}
              label="High Priority"
              value={initialRecommendations.filter((x) => x.priority === "High" || x.priority === "Critical").length}
